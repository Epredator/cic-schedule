...
public class CommonResources_Bundle_gecko1_8_es_MX_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_gecko1_8_es_MX_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_gecko1_8_es_MX_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GK40RFKDCB{display:" + ("\\-moz-inline-box")  + ";position:" + ("relative")  + ";display:" + ("inline-block")  + ";}");
      }
