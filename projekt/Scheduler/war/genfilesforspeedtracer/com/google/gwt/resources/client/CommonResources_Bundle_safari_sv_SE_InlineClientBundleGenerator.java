...
public class CommonResources_Bundle_safari_sv_SE_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_safari_sv_SE_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_safari_sv_SE_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GK40RFKDCB{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}");
      }
