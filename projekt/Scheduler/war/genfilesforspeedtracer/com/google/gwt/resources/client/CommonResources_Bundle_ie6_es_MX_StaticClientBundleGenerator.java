...
public class CommonResources_Bundle_ie6_es_MX_StaticClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_ie6_es_MX_StaticClientBundleGenerator _instance0 = new CommonResources_Bundle_ie6_es_MX_StaticClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GK40RFKDCB{position:" + ("relative")  + ";display:" + ("inline-block")  + ";zoom:" + ("1")  + ";display:" + ("inline")  + ";}");
      }
