...
public class SimplePager_Resources_nn_NO_StaticClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  private static SimplePager_Resources_nn_NO_StaticClientBundleGenerator _instance0 = new SimplePager_Resources_nn_NO_StaticClientBundleGenerator();
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".GK40RFKDGI{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GK40RFKDEI{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GK40RFKDFI{cursor:" + ("default")  + ";}");
      }
