...
public class DateFieldExample extends CustomComponent  {
    ...
    void basic(VerticalLayout layout) {
        ...
        layout.addComponent(new Label("<div style='height: 200px;'/>", Label.CONTENT_XHTML));
    }
    ...
    void formatting(VerticalLayout layout) {
        ...
        date.setLocale(new Locale("en", "US"));
        layout.addComponent(date);
        layout.addComponent(new Label("<div style='height: 150px;'/>", Label.CONTENT_XHTML));
    ...
    void parsing(final VerticalLayout layout) {
        ...
        dateValue.addListener(new Property.ValueChangeListener() {
        ...
        // Enable buffering
        date.setWriteThrough(true);
        //date.setReadThrough(true);
